...
# urejeni tabeli zlijemo. Pri zlivanju vsakič vzamemo najmanjši element z 
# začetka obeh tabel. Da smo še bolj učnkoviti navadno ne ustvarjamo nove 
# tabele, ampak rezultat zapisujemo v že pripravljeno tabelo (ustrezne dolžine).
# 
...
# Tabelo delimo na vedno manjše dele, ki jih uredimo in učinkovito zlijemo z
# uporabo funkcije [zlij].
...
# Za razliko od hitrega urejanja tu tabele lahko kopirate, zlivanja pa je 
